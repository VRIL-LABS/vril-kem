# VRIL-KEM v1.0-rc1 — Release Validation Report

**Date:** 2026-05-17  
**Environment:** Ubuntu 24.04.4 LTS (Noble Numbat), x86_64, AVX2 available  
**Release tag:** `v1.0-rc1`  
**Source:** [github.com/VrilLabs/kem/releases/tag/v1.0-rc1](https://github.com/VrilLabs/kem/releases/tag/v1.0-rc1)

---

## Summary

All linux-x64 compatible release artifacts from `v1.0-rc1` were validated on
...
`v1.0-rc1` source tag on Ubuntu 24.04.4 LTS x86_64. These will differ from
...
|---|---|---|
| `vril-kem-1024-3-ref-linux-x64-v1.0-rc1.tar.gz` | 294416 | `3b4e8d7116d0a7eb70a66aa5a21df76cfb028a5873fdc8007d8b8860b229618d` |
| `vril-kem-2048-5-ref-linux-x64-v1.0-rc1.tar.gz` | 53569 | `f00c8cd0621368a23a8b091f854dbdf2464cd83de4e0e07d8a14bf4b79857eac` |
| `vril-kem-4096-7-ref-linux-x64-v1.0-rc1.tar.gz` | 55827 | `742a448e43ef83a3ea1fef6749e78bd55392b0be9d70817afeec85a8aea8f2cc` |
| `vril-kem-1024-3-avx2-linux-x64-v1.0-rc1.tar.gz` | 57613 | `02297882fbed258d43c99a9a848763a11484b64162398c48717c096c322f0ebc` |
| `vril-kem-2048-5-avx2-linux-x64-v1.0-rc1.tar.gz` | 53825 | `63f9a4d796ba4acd61162e10e89c1c2dbc701c914364f7d55b72fb81f0213e3d` |
| `vril-kem-4096-7-avx2-linux-x64-v1.0-rc1.tar.gz` | 57774 | `00b87bd5721db005b81e26516616113645f6bcb4c4833ea7df8e67fc15f17163` |
| `vril-kem-1024-3-ct-linux-x64-v1.0-rc1.tar.gz` | 28814 | `2e65ecf7df7c45d897559c57e5b210dbc0b024085c241127dc1b7e5a4690d3c5` |
| `vril-kem-2048-5-ct-linux-x64-v1.0-rc1.tar.gz` | 28815 | `59b6ba5ba9a3807296965b112964c9b7c7b9575d6b8c37c83facd148e176a3c5` |
| `vril-kem-4096-7-ct-linux-x64-v1.0-rc1.tar.gz` | 33732 | `179e8cd8667f94e7374788752f6f1c0c2cc589996c569625b19de149a5af7482` |
| `vril-kem-1024-3-mem-linux-x64-v1.0-rc1.tar.gz` | 28816 | `993df1d5c14d96d2271df7ca22b86e997d6344f56802ceb89ff4e4bfcc918acb` |
| `vril-kem-2048-5-mem-linux-x64-v1.0-rc1.tar.gz` | 28819 | `61808aa4a40669a500a4422a17c92cefe99905326c19de97977edc52838b1fd7` |
| `vril-kem-4096-7-mem-linux-x64-v1.0-rc1.tar.gz` | 54493 | `967d3900b0790a75ce33f05b34b4a6d7a7e249682b592ba3017bc5c207534648` |
...
✅ **v1.0-rc1 is VALIDATED for linux-x64 release.**
